...
version__title:
print " PATCH VERSION: 65 "
nop

version__patchgame:
print " Patch & Legacy Patch Game: Password starts with ! or $ "
nop
version__patchgame_ex:
print " Patch Game ex: !123456  ||  Legacy Patch Game ex: $123456 "
nop
version__halogame:
...
print " ex: @123456 "
nop
version__patchPASSWORD:
print " Patch & SGL Game with Password: Password starts with # or % "
nop
version__patchPASSWORD_ex:
print " Patch w/ Pass ex: #123456   ||  SGL w/ pass ex: %123456 "
nop
version__patchPASSWORD_note:
print " NOTE: Players must enter this password including the # or % "
nop
...
// check if host persona pointer is populated, if not player has not joined/created a game
lui t0, $0044
lw t0, $14C0(t0)
// ffffffff = no ID
setreg t1, $ffffffff
...
// patch game password
setreg a0, :version__patchPASSWORD
setreg a1, $43200000
setreg a2, $43820000
setreg a3, $3F4CCCCD
setreg t0, $43000000
...
jal :version__print_text
nop
// patch game password ex
setreg a0, :version__patchPASSWORD_ex
setreg a1, $43200000
setreg a2, $438C0000
setreg a3, $3F4CCCCD
setreg t0, $43000000
...
jal :version__print_text
nop
// patch game password note
setreg a0, :version__patchPASSWORD_note
setreg a1, $431B0000 //43440000
setreg a2, $43950000
setreg a3, $3F333333
setreg t0, $43000000
setreg t1, $42800000
