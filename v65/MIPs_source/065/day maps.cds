...
// check if DLC maps are enabled
setreg s0, :DLC_MAPS_BOOL
lbu s0, $0000(s0)
bne s0, zero, :DAYMAPS_setDLCmaps
nop
...
beq zero, zero, :___end_map_stack_create
sw s1, $0000(s0)

DAYMAPS_setDLCmaps:
// DLC -- set map #
setreg s0, $00441654
addiu s1, zero, $27 // original count = 16
sw s1, $0000(s0)
// set maps listing
setreg s0, $00441658
setreg s1, :__custom_maps_start_DLC
sw s1, $0000(s0)
