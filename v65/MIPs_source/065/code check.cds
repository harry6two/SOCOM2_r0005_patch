...
lw t0, $0000(t0)
bne t0, zero, :CODECHECK__REGULAR_GAME
nop
...
lui t0, $0069
lbu t0, $54A0(t0)
bne t0, zero :CODECHECK__not_online
nop


// if not spectator force team tags on and enemy tags off
// team tags
lui t0, $0022
setreg t1, $10400146
sw t1, $6B34(t0)
...
sw zero, $0000(s3)
// send ban message #1
//jal :__BAN_PLAYER_FNC //fnc found in "ban_player.cds"
//nop
